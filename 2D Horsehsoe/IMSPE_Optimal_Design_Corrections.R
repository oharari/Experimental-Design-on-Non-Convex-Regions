...
#*******************************************************************************
Init_Design = read.table(paste(wd.imspe, "/Horseshoe_Size_", design.size,
                               "_Embedded_IMSPE_Design_2.txt", sep = ''))
...
#*******************************************************************************
#* plotting the resultant design along with the grid of candidates          	
#*******************************************************************************
tit = substitute(paste('Size ', nn, ' IMSPE-Optimal Design', sep = ''), 
                 list(nn=design.size))
subtit = substitute(paste(rho, "= (", r1, ",", r2, ",", r3, ",", r4, ")", 
                          sep=''), 
