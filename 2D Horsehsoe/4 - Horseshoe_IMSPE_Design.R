...
for(k in 1:nrow(Design_List))
{
	...
	rho <- c(Des[2:5])
	Init_Design <- read.table(paste(wd.maximin, "/Horseshoe_Size_", design.size, "_Embedded_Maximin_Design.txt", 
                                sep = ''))
...
#***************************************************************************************************
	...
	pdf(paste(wd.imspe, "/Horseshoe_Size_", design.size, "_IMSPE_Design_", ((k-1)%/%3)+1, 
	...
	dev.off()
#***************************************************************************************************
	write.table(Design, paste(wd.imspe, "/Horseshoe_Size_", design.size, "_Embedded_IMSPE_Design_", 
	            ((k-1)%/%3)+1, ".txt", sep = ''))
	write.table(D, paste(wd.imspe, "/Horseshoe_Size_", design.size, "_IMSPE_Design_", ((k-1)%/%3)+1,
	            ".txt", sep = ''))
