...
GeoD = as.matrix(read.table(paste0(wd, "/Simulation/Auxiliary_Files/Horseshoe_Geodesic_Distances_0.05.txt")))
mdsG = mds(GeoD)
V = mdsG$embedding
...
par(mar = c(5,5,2,2))
plot(e, xlab = expression(k), ylab = expression(RMSE[k]), cex.lab = 1.6, 
     type = 'l', lwd = 3)
